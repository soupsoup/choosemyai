...
from models import Category, Tool, User, AppearanceSettings, Comment, ToolVote, CommentVote
...
def seed_data():
    ...
    settings.button_background_color = '#0d6efd'
    settings.button_text_color = '#ffffff'
    settings.link_color = '#0d6efd'
    settings.link_hover_color = '#0a58ca'
    settings.category_badge_color = '#6c757d'
    settings.category_badge_hover_color = '#5c636a'
    settings.nav_link_color = '#ffffff'
    settings.nav_link_hover_color = '#e9ecef'
